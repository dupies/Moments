...
export function InfoBanner({address}) {
  ...
  const kibs = useMomentsBalance(address)
  ...
  const status = {
    notInitialized: {
      ...
      text:
        "You need to initialize your account before you can receive Moment.",
    },
    noMoment: {
      type: "info",
      title: "Get Moment",
      text: "You need Moment to buy Mmnt Items.",
    },
  }
